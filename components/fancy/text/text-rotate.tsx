...
type MotionTextRootProps = MotionProps &
  HTMLAttributes<HTMLElement> & {
    as?: ElementType
  }

const MotionTextRoot = motion(
  forwardRef<HTMLElement, MotionTextRootProps>(function MotionTextRoot(
    { as: Component = "p", children, ...rest },
    ref
  ) {
    return (
