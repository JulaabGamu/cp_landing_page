...
export function GradientButton({ href, onClick, children, className = "" }: GradientButtonProps) {
    ...
    const baseClasses = "inline-flex items-center justify-center text-white font-sans font-semibold text-lg transition-transform hover:scale-105 active:scale-95";
